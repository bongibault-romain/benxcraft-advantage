...
import fr.benxcraft.advantage.items.eatable.cannabis.CannabisLevelOne;
import fr.benxcraft.advantage.items.eatable.cannabis.CannabisLevelThree;
import fr.benxcraft.advantage.items.eatable.cannabis.CannabisLevelTwo;
...
public class ItemManager {
    ...
    public void load() {
        ...
        this.register(new CannabisLevelOne());
        this.register(new CannabisLevelTwo());
        this.register(new CannabisLevelThree());
